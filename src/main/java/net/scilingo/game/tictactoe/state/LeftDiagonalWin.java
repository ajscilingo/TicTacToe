...
public class LeftDiagonalWin extends AbstractGameState implements ToHtml, Winnable {
	
	public LeftDiagonalWin() {}
	
	@Override
	public String winnerMessage() {
		return new StringBuilder().append("Left Diagonal Win By ").append(player.toString())
	...
	public AbstractGameState isGameOver(TicTacToePlayer player) {
		if(player.hasLowerLeft() && player.hasMiddleMiddle() && player.hasUpperRight()) {
			setPlayer(player);
			return this;
		}
		else
