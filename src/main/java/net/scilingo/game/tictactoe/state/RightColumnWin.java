...
public class RightColumnWin extends AbstractGameState implements ToHtml, Winnable {

	public RightColumnWin() {
	}
	
	@Override
	public String winnerMessage() {
		return new StringBuilder().append("Right Column Win By ").append(player.toString())
	...
	public AbstractGameState isGameOver(TicTacToePlayer player) {
		if(player.hasUpperRight() && player.hasMiddleRight() && player.hasLowerRight()){
			setPlayer(player);
			return this;
		}
		else
